...
<div class="row my-3" id="addProject1" style = "display: block; margin-left: 30%;">
        ...
        <div class="col-md-15 col-12">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <option selected>Pick Property</option>
                    @foreach($propertys as $property)
                    <option value="{{$property->propertyID}}">{{$property->property_name}}</option>
                    @endforeach
                    </select>
                </div>
              </div>
...
<div class="col-md-8 col-12 d-flex mt-5 justify-content-between">
    <a href="#" class="btn  default-border-radius" type="button"
    style="border: 2px solid #662D91;">back</a>
    <button onclick="payout()" class="btn primary-background default-border-radius" style="width: 70%"
